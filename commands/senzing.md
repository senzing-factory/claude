...
1. If no $ARGUMENTS specified, ask user to choose a subcommand from the following list:
   ...
   1. `github-branches` - Lists a GitHub user's open branches.
   1. `github-issue-fix-proposal` - Based on a GitHub issue description, propose code changes.
   1. `github-issues` - Lists a GitHub user's open issues.
   1. `github-pull-requests` - List a GitHub user's open pull requests.
